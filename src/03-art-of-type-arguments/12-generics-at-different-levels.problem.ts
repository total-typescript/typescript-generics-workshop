...
export const getHomePageFeatureFlags1 = <Config extends {rawConfig: {featureFlags : {homePage : any}}}>(
  config: Config,
  override: (flags: Config["rawConfig"]["featureFlags"]["homePage"]) => Config["rawConfig"]["featureFlags"]["homePage"]
) => {
